...
import { ERRORS, createDeferred, Deferred, HardwareErrorCode } from '@chargerwallet/hd-shared';
import ReactNativeTransport from '@chargerwallet/hd-transport-react-native';
